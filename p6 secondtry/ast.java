...
class IdNode extends ExpNode {
    ...
    public void codeGen() {
        //will handle function calls and assign in their own codeGen
        //only for returning values onto stack
        if (mySym.getOffset() == 1) {
            //global
            Codegen.generate("lw", Codegen.T0, "_"+myStrVal);
        } else {
            Codegen.generate("lw", Codegen.T0, String.valueOf(mySym.getOffset())+"($fp)");
        }
        Codegen.genPush(Codegen.T0);
    }
...
class AssignNode extends ExpNode {
    ...
    public void codeGen() {
        //need to put the right-hand side onto the stack
        myExp.codeGen();
        Codegen.genPop(Codegen.A0);
...
class CallExpNode extends ExpNode {
    ...
    public void codeGen() {
        //need to setup to call a function
        //evaluate each param push them unto the stack
        myExpList.codeGen();
        //call jump and link
        if (myId.name().equals("main")) {
...
class DivideNode extends ArithmeticExpNode {
    ...
    public void codeGen() {
        ...
        Codegen.generate("move", Codegen.T0, Codegen.A0);
        Codegen.genPop(Codegen.A0);
        Codegen.generate("div", Codegen.A0, Codegen.A0, Codegen.T0);
        Codegen.genPush(Codegen.A0);
    }
...
class GreaterNode extends RelationalExpNode {
    ...
    public void codeGen() {
        ...
        Codegen.generate("move", Codegen.T0, Codegen.A0);
        Codegen.genPop(Codegen.A0);
        Codegen.generate("sgt", Codegen.A0, Codegen.A0, Codegen.T0);
        Codegen.genPush(Codegen.A0);
    }
}
